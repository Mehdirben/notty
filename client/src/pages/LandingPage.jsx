...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-dark-950 text-white overflow-hidden">
      ...
      <nav className="relative z-10 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          >
            ...
            <Link 
              to="/register" 
              className="px-6 py-2 bg-gradient-to-r from-primary-600 to-purple-600 rounded-full font-medium hover:shadow-lg hover:shadow-primary-500/30 transition-all"
            >
              Get Started
            </Link>
          </motion.div>
      ...
      <section className="relative z-10 px-6 pt-20 pb-32">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <Link 
              to="/register"
              className="group px-8 py-4 bg-gradient-to-r from-primary-600 to-purple-600 rounded-xl font-semibold text-lg hover:shadow-xl hover:shadow-primary-500/30 transition-all flex items-center gap-2"
            >
              Start Taking Notes
            ...
            <a 
              href="#features"
              className="px-8 py-4 bg-dark-800 border border-dark-700 rounded-xl font-semibold text-lg hover:bg-dark-700 transition-colors"
            >
              Learn More
            </a>
          </motion.div>
      ...
      {/* Features Section */}
      <section id="features" className="relative z-10 px-6 py-32 bg-dark-900/50">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="group p-6 bg-dark-800/50 border border-dark-700 rounded-2xl hover:border-primary-500/50 hover:bg-dark-800 transition-all"
              >
                <div className="w-12 h-12 bg-gradient-to-br from-primary-500/20 to-purple-600/20 rounded-xl flex items-center justify-center text-primary-400 mb-4 group-hover:scale-110 transition-transform">
                  {feature.icon}
                </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <div className="relative glass-dark rounded-3xl p-12">
              ...
              <Link 
                to="/register"
                className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-primary-600 to-purple-600 rounded-xl font-semibold text-lg hover:shadow-xl hover:shadow-primary-500/30 transition-all"
              >
